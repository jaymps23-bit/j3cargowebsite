...
const STATE_RATES = [
  { state: "Lagos", delivery: 6, collection: 5.7, min: 60 },
  { state: "Oyo", delivery: 6.3, collection: 6.3, min: 80 },
  { state: "Ogun", delivery: 6.5, collection: 6.5, min: 80 },
  { state: "Ondo", delivery: 6.5, collection: 6.5, min: 80 },
  { state: "Osun", delivery: 6.5, collection: 6.5, min: 80 },
  { state: "Ekiti", delivery: 6.5, collection: 6.3, min: 80 },
  { state: "Kwara", delivery: 6.5, collection: 6.3, min: 85 },
  { state: "Abia", delivery: 7, collection: 6.7, min: 85 },
  { state: "Abuja (FCT)", delivery: 7, collection: 6.7, min: 85 },
  { state: "Akwa Ibom", delivery: 7, collection: 6.7, min: 85 },
  { state: "Anambra", delivery: 7, collection: 6.7, min: 85 },
  { state: "Bayelsa", delivery: 7, collection: 6.7, min: 85 },
  { state: "Benue", delivery: 7, collection: 6.7, min: 85 },
  { state: "Cross River", delivery: 7, collection: 6.7, min: 85 },
  { state: "Delta", delivery: 7, collection: 6.7, min: 85 },
  { state: "Ebonyi", delivery: 7, collection: 6.7, min: 85 },
  { state: "Edo", delivery: 7, collection: 6.7, min: 85 },
  { state: "Enugu", delivery: 7, collection: 6.7, min: 85 },
  { state: "Imo", delivery: 7, collection: 6.7, min: 85 },
  { state: "Rivers", delivery: 7, collection: 6.7, min: 85 },
  { state: "Yobe", delivery: 7, collection: 6.5, min: 90 },
  { state: "Bauchi", delivery: 7.5, collection: 7, min: 95 },
  { state: "Gombe", delivery: 7.5, collection: 7, min: 95 },
  { state: "Jigawa", delivery: 7.5, collection: 7, min: 95 },
  { state: "Kaduna", delivery: 7.5, collection: 7, min: 95 },
  { state: "Kano", delivery: 7.5, collection: 7, min: 95 },
  { state: "Katsina", delivery: 7.5, collection: 7, min: 95 },
  { state: "Kebbi", delivery: 7.5, collection: 7, min: 95 },
  { state: "Kogi", delivery: 7.5, collection: 7, min: 95 },
  { state: "Plateau", delivery: 7.5, collection: 7, min: 95 },
  { state: "Sokoto", delivery: 7.5, collection: 7, min: 95 },
  { state: "Taraba", delivery: 7.5, collection: 7, min: 95 },
  { state: "Zamfara", delivery: 8, collection: 7.5, min: 95 },
  { state: "Adamawa", delivery: 8, collection: 7.5, min: 95 },
  { state: "Borno", delivery: 8, collection: 7.5, min: 95 },
  { state: "Nasarawa", delivery: 8, collection: 7.5, min: 100 },
  { state: "Niger", delivery: 8, collection: 7.5, min: 100 },
];
        ...
        <div className="container py-4">
          <div className="flex items-start gap-3">
            ...
            <p className="text-sm text-foreground/80">
              Rates shown are for <strong>air freight</strong> per kilogram. Minimum charge of £60 applies for shipments under 8kg. Delivery to Lagos takes 7–10 working days; outside Lagos takes an additional 2–3 days. For sea freight or hazardous materials, please <Link href="/contact" className="text-navy font-medium underline">contact us</Link>.
            </p>
          </div>
        </div>
      </section>
