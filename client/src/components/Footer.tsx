        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-sky/20 hover:text-sky transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-white/60 hover:text-sky transition-colors text-sm">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href={`tel:${BUSINESS.phone}`} className="flex items-start gap-3 text-white/60 hover:text-sky transition-colors text-sm">
                  <Phone className="w-4 h-4 mt-0.5 shrink-0 text-sky" />
                  {BUSINESS.phone}
                </a>
              </li>
              <li>
                <a href={`mailto:${BUSINESS.email}`} className="flex items-start gap-3 text-white/60 hover:text-sky transition-colors text-sm">
                  <Mail className="w-4 h-4 mt-0.5 shrink-0 text-sky" />
                  {BUSINESS.email}
                </a>
              </li>
              <li>
            ...
            <div className="mt-6 p-4 bg-white/5 rounded-xl">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-sm text-sky hover:text-sky-light transition-colors font-medium"
              >
                Chat on WhatsApp →
              </a>
            </div>
